		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Var4 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
				...
				templ_7745c5c3_Var5 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
					...
					_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<ul class=\"list-inside list-disc\"><li>An n8n workflow that reads the CSV file published by the MoH. Locations are then categorized and saved.</li><li>An n8n workflow endpoint that returns all the locations in the last 30 days.</li><li>A statically rendered Next.JS site that is published each hour. A mobile-friendly interactive map with all locations marked.</li><li>A hourly job to build sub-reddit content and sent updates to places with new/updated Locations of Interest.</li></ul><h1 class=\"text-2xl font-bold mt-4\">Why so complex?</h1><ul class=\"list-inside list-disc\"><p>To reduce the complexity, cost and on-going maintenance cost of the application, i removed the n8n workflow the Next.JS site build on and replaced it with direct calls to the MoH API.</p><p>This allowed the site to be fully independent of my own local infrastructure and for its whole lifetime, run entirely for free on Vercel</p></ul>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
					if !templ_7745c5c3_IsBuffer {
